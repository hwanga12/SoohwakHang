...
| `B` 고습도 곰팡이 반복 | `humidity=84`, `soil_moisture=20`, `class_name=tomato_gray_mold`, `repeat_count=2` | 급수 보류 자동 적용 |
| `C` 착화/과실기 칼슘 결핍 의심 | `growth_stage=flowering_fruiting_stage`, `class_name=blossom_end_rot` | 칼슘 보강제 `250 ml` 승인 후 실행 |
